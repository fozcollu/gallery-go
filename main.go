...
import (
	...
	"galleries.com/controllers"
	"galleries.com/email"
	"galleries.com/middleware"
...
func main() {
	...
	// Burada servisler initleniyor. connectionlar filan açılıyor.
	...
	emailer := email.NewClient(
		email.WithSender("galleries.com Support", "support@mg.galleries.com"),
